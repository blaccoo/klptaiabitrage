  ...
  if (done == 0) {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          Msg(
            "<strong><i class='fa fa-check-square'></i>&nbsp;</strong> Successfully logged out",
            "alert-success",
            0,
            "#system_msg",
            10000
          ...
          Msg(
            "<strong><em class='icon ni ni-cross-c'></em>&nbsp;</strong> System Error. Refresh page and try again!",
            "alert-danger",
            0,
            "#system_msg",
            12000
          ...
          Msg(
            "<strong><em class='icon ni ni-cross-c'></em>&nbsp;</strong> Unknown error. please try again",
            "alert-danger",
            0,
            "#system_msg",
            12000
...
function quick_contact(x) {
  if (
    $("#form_name1").val().length == 0 ||
    $("#form_email1").val().length == 0 ||
    $("#form_subject1").val().length == 0 ||
    $("#form_message1").val().length == 0
  ) {
    Msg(
      "<i class='fa fa-warning'></i>&nbsp; fill all fields!!!",
      "alert-danger",
      0,
      "#status",
      10000
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          Msg(
            "<strong><i class='fa fa-check-square'></i>&nbsp;  Sent successfuly</strong>",
            "alert-success",
            0,
            "#status",
            6000
          ...
          Msg(
            "<strong><i class='fa fa-warning'></i>&nbsp; fill all fields!!!</strong>",
            "alert-danger",
            0,
            "#status",
            10000
          ...
          Msg(
            "<strong><i class='fa fa-warning'></i>&nbsp; account does not exist</strong>",
            "alert-danger",
            0,
            "#status",
            10000
          ...
          Msg(
            "<strong><i class='fa fa-warning'></i>&nbsp; Unknown error. please try again" +
              data +
              "</strong>",
            "alert-danger",
            0,
  ...
  if ($("#form_name").val().length == 0) {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          Msg(
            "<strong><i class='fa fa-check-square'></i>&nbsp;</strong>  Message received. We'll get back to you ASAP",
            "alert-success",
            0,
            status,
            6000
          ...
          Msg(
            "<strong><i class='fa fa-warning'></i>&nbsp;</strong> fill all fields !!!",
            "alert-danger",
            0,
            status,
            10000
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          Msg(
            "<strong><i class='fa fa-check-square'></i>&nbsp;  Newsletter successfuly subscribed</strong>",
            "alert-success",
            0,
            "#letterstatus",
            6000
          ...
          Msg(
            "<strong><i class='fa fa-warning'></i>&nbsp; Unknown error. please try again</strong>",
            "alert-danger",
            0,
            "#letterstatus",
            10000
