$(function () {
  ...
  var options = {
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              fontWeight: "600",
              label:
                total_label.toLocaleString(undefined, {
    ...
    colors: ["var(--bs-info)", "var(--bs-success)"],
  ...
  var expense = {
    ...
    colors: ["#4dbcb1", "var(--bs-secondary)", "var(--bs-yellow)"],
    dataLabels: {
      enabled: false,
    },
  ...
  var options = {
    ...
    colors: ["#4dbcb1", "var(--bs-secondary)", "var(--bs-gray-200)"],
    grid: {
      show: false,
    },
    plotOptions: {
