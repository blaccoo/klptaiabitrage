$(function () {
  ...
  var options = {
    ...
    colors: ["#4dbcb1", "#EAEFF4", "var(--bs-secondary)"],
  ...
  var options = {
    ...
    colors: ["#4dbcb1", "var(--bs-secondary)"],
  ...
  var options = {
    ...
    colors: ["#F2F3F9", "#F2F3F9", "#4dbcb1", "#F2F3F9", "#F2F3F9", "#F2F3F9"],
    plotOptions: {
      bar: {
        borderRadius: 3,
        columnWidth: "45%",
  ...
  var options = {
    ...
    colors: ["var(--bs-secondary)", "#EAEFF4", "#4dbcb1"],
  ...
  var chart = new ApexCharts(
    document.querySelector("#sales-overview1"),
    options
  );
  chart.render();
});
